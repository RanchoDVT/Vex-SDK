...
namespace vex {
  ...
  */
  class controller {
    ...
    public:
      // V5/EXP controller buttons (not all available on EXP controller)
      /**
      ...
      /**
       * @brief A button that represents the L3 button on the EXP controller.
       */
      const button  ButtonL3    = button( tButtonType::kButtonG    , this );
      /**
       * @brief A button that represents the R3 button on the EXP controller.
       */
