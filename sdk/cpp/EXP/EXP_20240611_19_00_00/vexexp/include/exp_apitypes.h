 ...
 *   };
 *
 *   EX_SIG_MAGIC must be set, other fields and their behavior are TBD
 *
...
vcodesig  vexCodeSig  __attribute__ ((section (".boot_data"))) = \
 { EX_SIG_MAGIC, type, owner, options };
...
typedef enum _V5_ControllerIndex {
    kV5ControllerAnaLeftX    =   0,
    kV5ControllerAnaLeftY,
    kV5ControllerAnaRightX,
    kV5ControllerAnaRightY,
    kV5ControllerAnaLeftWheel,
    kV5ControllerAnaRightWheel,

    kV5ControllerButton5U,
    kV5ControllerButton5D,
    kV5ControllerButton6U,
    kV5ControllerButton6D,
    kV5ControllerButton7U,
    kV5ControllerButton7D,
    kV5ControllerButton7L,
    kV5ControllerButton7R,
    kV5ControllerButton8U,
    kV5ControllerButton8D,
    kV5ControllerButton8L,
    kV5ControllerButton8R,

    kV5ControllerButtonG,     // not exist
    kV5ControllerButtonH,     // not exist
    kV5ControllerButtonSpare1,// not exist
    kV5ControllerButtonSpare2,// not exist

    kV5ControllerButtonSEL,

    kV5ControllerBatteryLevel,

    // Used for set
    kV5ControllerButtonAll,
    kV5ControllerFlags,
    
    kV5ControllerBatteryCapacity,
    kV5ControllerSignalStrength,
    
    kV5ControllerdevStatus = 0x80,         // private
    kV5ControllerdevFlags,                 // private
    kV5ControllerCalStatus,                // private
    kV5ControllerSysStatus,                // private
    kV5ControllerFieldStatus               // private
} V5_ControllerIndex;
