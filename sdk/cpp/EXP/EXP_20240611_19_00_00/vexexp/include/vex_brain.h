  ...
  class brain {
    ...
    public:
      ...
      */
      ...
      /**
       * @brief A button that represents the Left button on the brain
       */
      button       buttonUp    = button(0);
      button      &buttonLeft  = buttonUp;
      /**
       * @brief A button that represents the Right button on the brain
       */
      ...
      class lcd {
        ...
        public:
          ...
          */
           ...
           *  no larger than the EXP Screen, that is, a maximum of 160 pixels wide by 128 pixels high.
          ...
          */
           ...
           *  The image should be no larger than the EXP Screen, that is, a maximum of 160 pixels wide by 128 pixels high.
           *  The top/left corner of the image is placed at the coordinates given by x and y, these can
           *  be negative if desired.
          */
           ...
           *  The file should be no larger than 64K bytes and must have either a ".bmp" or ".png" extension.
           *  The image should be no larger than the EXP Screen, that is, a maximum of 160 pixels wide by 128 pixels high.
           *  The top/left corner of the image is placed at the coordinates given by x and y, these can
           *  be negative if desired.
          */
...
/*----------------------------------------------------------------------------*/
       ...
       */
      triport     ThreeWirePort = triport( PORT11 );
...
/*----------------------------------------------------------------------------*/
      ...
      */      
       ...
       */
      void        playSound( soundType sound, uint32_t volume = 100 );
       ...
       */
      void        playNote( int32_t octave, int32_t note, int32_t ms, int32_t volume = 50 );
      /** 
       ...
       * @notes wav file should be mono, 8 bit, 22.5k max sampling
       */
      void        playFile( char *filename, uint32_t volume = 100, uint32_t source = 0 );
      /** 
       * @brief is a sound currently playing
       */
      bool        soundIsActive(void);
      /** 
       * @brief total duration of playing sound in mS
       */
      uint32_t    soundDuration(void);
      /** 
       * @brief remaining duration of playing sound in mS
       */
      uint32_t    soundRemaining(void);
      /** 
