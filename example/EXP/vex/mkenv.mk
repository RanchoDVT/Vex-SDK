...
TOOL_INC  = -I"$(VEX_SDK_PATH)/$(PLATFORM)/clang/$(HEADERS)/include" -I"$(VEX_SDK_PATH)/$(PLATFORM)/gcc/include/c++/13.2.1" -I"$(VEX_SDK_PATH)/$(PLATFORM)/gcc/include/c++/13.2.1/arm-none-eabi" -I"$(VEX_SDK_PATH)/$(PLATFORM)/gcc/include"
